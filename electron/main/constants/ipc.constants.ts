export const IPC_CHANNELS = {
  ...
  DATA_CREATE_SCHEDULED_BACKUP: 'data-transfer:create-scheduled-backup',
  ...
  SETTINGS_OPEN_BACKUP_DIRECTORY: 'settings:open-backup-directory',
  SETTINGS_PICK_BACKUP_DIRECTORY: 'settings:pick-backup-directory',
